...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    ...
    Color bgColor =
        data['isDaytime'] ? Colors.lightBlue[400] : Colors.indigo;
                ...
                children: <Widget>[
                  FlatButton.icon(
                    onPressed: () {
                      Navigator.pushNamed(context,
                          '/location'); // Pushing a new screen on top of it
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        data['location'],
                        style: TextStyle(fontSize: 20.0, letterSpacing: 2.0, color: fontColor),
                      )
                    ],
                  ),
                  SizedBox(
